...
- **Confirmed cases and deaths:** this data is collected from the [World Health Organization Coronavirus Dashboard](https://data.who.int/dashboards/covid19/cases). The cases & deaths dataset is updated daily.
